...
| --- | --- | --- | --- | --- | --- |
| 摊位建档 | 系统管理员 | 经营者、地点、品类、营业时间 | 创建档案并配置公开范围 | 摊位档案、二维码标识 | 照片证照上传 |
| 公开资料发布 | 系统管理员 | 摊位照片、公开字段、两类证照 | 核验后发布 | H5 当前生效版本 | 公众查询 |
...
建议后台按九个功能域组织：工作台、摊位档案、公开信息审核、地图服务点、H5 用户与身份、评分管理、检查整改、投诉反馈、系统配置与审计。所有后台页面和操作统一归属系统管理员；原型阶段优先跑通“建档发布”“变更审核”“点位发布”“身份绑定”“检查监管”“投诉分派与办结”六条 P0/P1 流程。
