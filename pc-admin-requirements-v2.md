...
| 工作模式 | 资料整理模式 |
| 输出深度 | standard |
| 版本 | V0.5（补充审核未通过、打回补正及 H5 摊主认证入口） |
| 更新时间 | 2026-07-16 |
...
| --- | --- | --- | --- | --- | --- |
| 首次摊位审核 | 摊主提交、系统管理员审核 | 经营者、地点、品类、营业时间、照片等摊位资料 | 核验资料并通过、未通过或打回补正 | 审核结果；通过后进入发证 | 发放设置证 |
| 发证与二维码生成 | 系统管理员 | 已通过的首次摊位审核、证件有效期 | 发放临时摊位设置证并生成唯一二维码 | 设置证、二维码、H5 首个公开版本 | 公众查询 |
| 摊主资料变更 | 摊主提交、系统管理员审核 | 经营资料变更申请 | 原值/新值对比，整单通过、未通过或打回补正 | 新生效版本、未通过结果或打回理由 | H5 更新/摊主补正 |
| 设置证临期续审 | 系统提醒、摊主提交、系统管理员审核 | 临期设置证、最新摊位资料、续审材料 | H5 提醒，摊主提交，管理员重新审核并更新有效期 | 新设置证及有效期、未通过结果或打回理由 | H5 证照更新/补正 |
...
| 摊主认证申请 | H5 未认证用户提交、系统管理员审核 | 实名信息、联系方式、摊位关系及认证材料 | 通过、审核未通过或打回补正 | 摊主身份或审核结果 | 首次摊位信息提交/补正 |
...
| 审核结果 | 审核支持“审核通过、审核未通过、打回补正”三种结果 | 明确提及 |
| 打回补正 | 打回操作必须填写打回理由；申请保留并回到申请人，补充后可再次提交 | 明确提及 |
| 审核未通过 | 申请进入“审核未通过”终态，不发证、不生成二维码；重新申请需新建申请记录 | 合理推断 |
...
| --- | --- |
| 摊位 | 正常经营、暂停经营、已注销 |
| 摊位审核 | 草稿、待审核、审核通过、审核未通过、已打回、补正中、已重新提交 |
| 二维码 | 未生成、已生成、已停用 |
| 临时摊位设置证 | 待发放、有效、临期、续审中、已过期、已作废 |
| H5 公开版本 | 未发布、已发布、更新审核中、已下线 |
| 身份认证 | 未提交、待审核、已认证、审核未通过、已打回、补正中、已停用 |
| 地图点位 | 启用、停用、待核验 |
...
| Q-PC-12 | “审核未通过”后是否允许申请人复制原资料重新申请，是否设置再次申请间隔？ | P1 | 重新申请体验和风控 |
